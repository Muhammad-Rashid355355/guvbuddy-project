    ...
    return(
      ...
      <Row className='main_row' justify='center'>
           ...
           <Row className='second_row' justify='center' >
                ...
                <Button className='commit_btn2' shape='round'>Comit on guvbuddy</Button>
                </Col>
           </Row>
           <Row >
...
<path d="M6.5 12L0.00481036 0.749999L12.9952 0.75L6.5 12Z" fill="#2F80ED"/>
                   ...
                   <DownOutlined />
                     ...
                     <h3 className="patterson_text_l">Patterson,Jim</h3>
                     </Col>
                     <Col xs={24} sm={3} lg={4} xl={4} xxl={4}>
                     <h3 className="chair_text_l">Chair</h3>
                     </Col>
...
<path d="M6.5 12L0.00481036 0.749999L12.9952 0.75L6.5 12Z" fill="#27AE60"/>
                          ...
                          <span className="ant_dropdown2_staff2">Staff</span> 
                   ...
                   <DownOutlined />
                     ...
                     <Col xs={24} sm={3} lg={4} xl={4} xxl={4}>
                     <h3 className="chair_text2_l">Chair</h3>
                     </Col>
                     <Col xs={24} sm={2} lg={3} xl={3} xxl={3}>
                     <h3 className="D_text">(D)</h3>
                     </Col>
...
<path d="M6.5 12L0.00481036 0.749999L12.9952 0.75L6.5 12Z" fill="#2F80ED"/>
                     ...
                     <Row className="data_record_div3" align='middle'>
                     <Col xs={24} sm={2} lg={2} xl={2} xxl={2}>
                     <input type='radio' className='radio_input'/>
                     </Col>
                     <Col xs={24} sm={2} lg={2} xl={2} xxl={2}>
                     ...
                     <Col xs={24} sm={8} lg={6} xl={6} xxl={6}>
                     <h3 className="patterson_text_cross">Patterson,Jim</h3>
                     </Col>
                     <Col xs={24} sm={3} lg={4} xl={4} xxl={4}>
                     <h3 className="chair_text_cross">Chair</h3>
                     </Col>
                     <Col xs={24} sm={2} lg={3} xl={3} xxl={3}>
                     <h3 className="D_text_cross">(D)</h3>
                     </Col>
                     <Col xs={24} sm={6} lg={6} xl={6} xxl={6}>
                     <h3 className='state_assembly_text_cross'>State Assembly</h3>
                     </Col>
                     </Row>
                     <Row align='middle' className="ant-dropdown-link3">
...
<path d="M6.5 12L0.00481036 0.749999L12.9952 0.75L6.5 12Z" fill="#27AE60"/>
                     ...
                     <Col xs={24} sm={8} lg={6} xl={6} xxl={6}>
                     <h3 className="patterson_text2_l">Patterson,Jim</h3>
                     </Col>
                     <Col xs={24} sm={3} lg={4} xl={4} xxl={4}>
